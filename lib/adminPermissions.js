export const ADMIN_PERMISSION_DEFINITIONS = [
  ...
  { key: "marketing", label: "Marketing", description: "Campanhas e conteúdo sazonal da landing." },
...
export const ADMIN_LEVEL_DEFAULTS = {
  ...
  ADMIN: {
    ...
    support: true, staff: false, petsFinance: true, marketing: false, settings: false,
  },
  ATTENDANT: {
    dashboard: false, tributes: false, clients: false, payments: false,
    plans: false, analytics: false, coupons: false, pets: false,
    support: true, staff: false, petsFinance: false, marketing: false, settings: false,
  },
};
