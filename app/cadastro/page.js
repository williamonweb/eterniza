    ...
    <main className="auth-page">
      ...
      <section className="auth-shell">
        <aside className="auth-brand">
          ...
          <h1>
            Comece sua primeira <em>experiência Eterniza.</em>
          </h1>

          <p>
            Crie sua conta para montar homenagens com fotos, música, carta, QR Code e link
            exclusivo.
          </p>

          <div className="auth-mini">
            <div>❤️ Ideal para amor, mãe, pai, filhos e amigos</div>
            <div>🎁 Pronto para vender como presente digital</div>
            <div>✨ Experiência premium em poucos minutos</div>
          </div>
        </aside>

        <div className="auth-card">
          <form className="auth-box" onSubmit={criar} noValidate>
            <h2>Criar conta</h2>
            ...
            <div className="auth-row">
              <label>
                <input type="checkbox" required /> Concordo com os termos
              </label>
            </div>
